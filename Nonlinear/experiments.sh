...
echo "Linear NN Controller Training. Started at:" >> ./loggs/progress_information.txt
...
echo "Linear NN Controller Training. Ended at:" >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n\n" >> ./loggs/progress_information.txt


# Nonlinear DNN Controller
echo "Nonlinear DNN Controller Training. Started at:" >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Nonlinear DNN Controller Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n\n" >> ./loggs/progress_information.txt

# Comparison
printf "Controller Comparison. Started at:" >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
python3 compare.py > ./loggs/comparison.txt
printf "Controller Comparison. Ended at:" >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n \n" >> ./loggs/progress_information.txt

#Parameter Variation 1

echo "Parameter Variation 1 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 1 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt

#Parameter Variation 2

echo "Parameter Variation 2 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 2 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 3
echo "Parameter Variation 3 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 3 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 4
echo "Parameter Variation 4 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 4 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 5
echo "Parameter Variation 5 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 5 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 6
echo "Parameter Variation 6 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 6 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 7
echo "Parameter Variation 7 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 7 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 8
echo "Parameter Variation 8 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 8 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 9
echo "Parameter Variation 9 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 9 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 10
echo "Parameter Variation 10 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 10 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt

#Parameter Variation 11
echo "Parameter Variation 11 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 11 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt


#Parameter Variation 12
echo "Parameter Variation 12 Training. Started at: " >> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
...
echo "Parameter Variation 12 Training. Ended at:">> ./loggs/progress_information.txt
echo $(date) >> ./loggs/progress_information.txt
printf "\n" >> ./loggs/progress_information.txt
